...
import { VSCodeAutocompleteTextField, AutocompleteOption } from './components';
...
export default function DemoPage() {
  ...
  const [selected, setSelected] = React.useState<AutocompleteOption | null>(null);
  ...
  return (
    ...
    {selected && (
        ...
        <strong>Selected:</strong> {selected.label || selected.value}
        </div>
    )}
    </div>
  );
